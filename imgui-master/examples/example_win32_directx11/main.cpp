...
int main(int, char**)
{
    ...
    ::RegisterClassExW(&wc);
    HWND hwnd = ::CreateWindowW(wc.lpszClassName, L"Smart Stock Flow", WS_OVERLAPPEDWINDOW, 100, 100, (int)(800 * main_scale), (int)(500 * main_scale), nullptr, nullptr, wc.hInstance, nullptr);
